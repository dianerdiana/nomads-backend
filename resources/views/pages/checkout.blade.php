              ...
              <table class="table text-center">
                ...
                <tbody>
                  <tr>
                    <td>
                      <img
                        src="{{ url("frontend/assets/images/avatar-4.png") }}"
                        height="60px"
                      />
                    </td>
                  ...
                  <tr>
                    <td>
                      <img
                        src="{{ url("frontend/assets/images/avatar-5.png") }}"
                        height="60px"
                      />
                    </td>
            ...
            <div class="member mt-3">
              ...
              <form action="" class="row">
                ...
                <div class="col-lg-2 col-sm-12">
                  <label for="inputVisa" class="visually-hidden"
                    >Visa</label
                  >
                  <select
                    name="inputVisa"
          ...
          <div class="card card-details card-right">
            ...
            <div class="bank">
              <div class="bank-item pb-3">
                <img
                  src="{{ url("frontend/assets/icons/ic_bank.png") }}"
                  alt=""
                  class="bank-image"
                />
